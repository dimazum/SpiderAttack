...
public class PickShop : MonoBehaviour, IListener
{
    ...
    void Start()
    {
        ...
        if (GameStates.Instance.NextPick == null)
        {
            ...
            CurrentPick.GetComponent<Image>().sprite = Picks.transform.GetChild(GameStates.Instance.PickLvl - 1).GetComponent<Pick>().sprite;

            NewPick.GetComponent<Image>().sprite = Picks.transform.GetChild(GameStates.Instance.PickLvl ).GetComponent<Pick>().sprite;
        }
        else
        {
            CurrentPick.GetComponent<Image>().sprite = Picks.transform.GetChild(GameStates.Instance.PickLvl).GetComponent<Pick>().sprite;

            NewPick.GetComponent<Image>().sprite = Picks.transform.GetChild(GameStates.Instance.PickLvl + 1).GetComponent<Pick>().sprite;
        }
